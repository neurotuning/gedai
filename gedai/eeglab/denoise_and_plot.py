...
gedai = Gedai()
gedai.fit_raw(raw, noise_multiplier=6., n_jobs=n_jobs)
raw_corrected = gedai.transform_raw(raw)

gedai_spectral = Gedai(wavelet_type='haar', wavelet_level=9, low_cutoff=1.0)
