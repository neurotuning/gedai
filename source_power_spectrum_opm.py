...
gedai_grad = Gedai(wavelet_level=8, wavelet_low_cutoff=0.5, epoch_size_in_cycles=12, signal_type="meg")
...
gedai_mag = Gedai(wavelet_level=8, wavelet_low_cutoff=0.5, epoch_size_in_cycles=12, signal_type="meg")
...
gedai_opm = Gedai(wavelet_level=8, wavelet_low_cutoff=0.5, epoch_size_in_cycles=12, signal_type="meg")
