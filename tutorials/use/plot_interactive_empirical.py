"""
Interactive Overlay and SENSAI Visualization for Empirical Noise Data
====================================================================
"""
...
# 1. Load dataset (empirical NOISE EOG/EMG example)
default_path = r"C:\Users\Ros\Documents\MATLAB\eeglab2025.0.0\plugins\GEDAI-master\example data\empirical_NOISE_EOG_EMG.set"
...
plot_mne_style_overlay_interactive(
    raw,
    denoised_raw,
    title="GEDAI Denoising on Empirical Data: Noisy (Red) vs Cleaned (Blue)",
    duration=10.0,
)
